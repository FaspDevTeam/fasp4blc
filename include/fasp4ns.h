...
typedef struct precond_ns_data {
    ...
    /*---------------------------------------------------*/
    /* Iterative solver parameters for the velocity block*/
    /*---------------------------------------------------*/
    ...
    /*---------------------------------------------------*/
    ILU_data* ILU_p; /**< ILU data for pressure block */
...
typedef struct {
    ...
    INT   AMG_maxit_v;               /**< number of iterations as preconditioner */
    SHORT AMG_ILU_levels_v;          /**< how many levels use ILU smoother */
    SHORT AMG_coarse_scaling_v;      /**< scaling of the coarse grid correction */
    SHORT AMG_amli_degree_v;         /**< degree of the polynomial used by AMLI cycle */
    SHORT AMG_nl_amli_krylov_type_v; /**< Krylov method used by nonlinear AMLI cycle */
    ...
    INT   AMG_aggressive_path_v;      /**< number of paths to find coupled C-set */
    ...
    REAL  AMG_tentative_smooth_v; /**< relaxation factor for smoothing tentative P */
    SHORT AMG_smooth_filter_v;    /**< filter for smoothing the tentative P or not */
    ...
    INT   AMG_maxit_p;               /**< number of iterations as preconditioner */
    SHORT AMG_ILU_levels_p;          /**< how many levels use ILU smoother */
    SHORT AMG_coarse_scaling_p;      /**< scaling of the coarse grid correction */
    SHORT AMG_amli_degree_p;         /**< degree of the polynomial used by AMLI cycle */
    SHORT AMG_nl_amli_krylov_type_p; /**< krylov method used by nonlinear AMLI cycle */
    ...
    INT   AMG_aggressive_path_p;      /**< number of paths to find coupled C-set */
    ...
    REAL AMG_tentative_smooth_p; /**< relaxation factor for smoothing the tentative P */
    SHORT AMG_smooth_filter_p;   /**< filter for smoothing the tentative P or not */
